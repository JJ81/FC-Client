          ...
          async.whilst(
            ...
            function (callback) {
              ...
              if (user_quiz.answer_column === 'answer_desc') {
                ...
                if (user_quiz.answer_ids.length !== data_quiz.answer.length || !data_quiz.answer.length || !user_quiz.answer_ids.length)                  { result.iscorrect = false; }                else {
                  for (var i = 0; i < data_quiz.answer.length; i++) {
                    for (var j = 0; j < user_quiz.answer_ids.length; j++) {
                      ...
                      if (user_quiz.answer_ids[j] !== data_quiz.answer[i])                        { result.iscorrect = false; }                      else {
